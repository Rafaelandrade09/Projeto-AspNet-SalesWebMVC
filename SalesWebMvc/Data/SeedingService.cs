...
namespace SalesWebMvc.Data
{
    ...
    {
        // Apos a criacao desta classe, foi feito um registro dela em nosso metodo de Injecao ao Banco no Startup.cs line 45 
        ...
        // Metodo para povoar nosso Banco

        public void Seed()
        {
            // Verificando se existe algum registro no banco de dados ref. a cada tabela. Any() faz essa verificação!!
            if(_context.Department.Any() || 
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; // Se IF == True, o return corta a operação
            }

            // Criando registros de Departamentos
            Department d1 = new Department(9, "Computers");
            Department d2 = new Department(10, "Electronics");
            Department d3 = new Department(11, "Fashion");
            Department d4 = new Department(12, "Books");

            // Crinado registros de Vendedores
            ...
            // Add objetos no Banco de dados com AddRange() que permite add mais de um obj
            ...
            _context.SaveChanges(); // Para confirmar e salvar no Banco


            // Essa operacao sera chamada  dentro do Startup no metodo Configure, line 51 e 56
